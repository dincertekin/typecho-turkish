...
<section id="custom-field"
    ...
    <div class="description clearfix">
        ...
        <?php _e('Özel alanlar şablonunuzun işlevselliğini artırabilir, bunların nasıl kullanılacağını öğrenmek için <a href="https://docs.typecho.org/help/custom-fields">yardım belgelerine</a> bakın.'); ?>
    </div>
</section>
