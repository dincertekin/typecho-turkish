...
<div class="typecho-login-wrap">
	<div class="typecho-login">
		...
		<form action="<?php $options->loginAction(); ?>" method="post" name="login" role="form">
			...
			<p>
				<label for="remember">
					<input<?php if(\Typecho\Cookie::get('__typecho_remember_remember')): ?> checked<?php endif; ?> type="checkbox" name="remember" class="checkbox" value="1" id="remember" /> <?php _e('Beni hatırla'); ?>
				</label>
			</p>
		</form>
